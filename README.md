...
**Note**: The repository for this project contains only a portion of the original codebase. The complete implementation is saved privately. The snippets provided are intended for demonstration and educational purposes.
